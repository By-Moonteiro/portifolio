    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-1">
          <div className="flex items-center gap-3">
            <span
              ...
              style={{ color: project.status === "WIP" ? "var(--accent)" : "var(--foreground-muted)" }}
            >
              {project.status === "WIP" && (
          ...
          <h2 className="font-mono text-lg font-bold tracking-wide uppercase" style={{ color: "var(--foreground)" }}>
            {project.name}
          </h2>
        </div>
        ...
        <div className="flex flex-col gap-3 pt-4" style={{ borderTop: "1px solid var(--border)" }}>
          <h3 className="font-mono text-xs tracking-widest uppercase" style={{ color: "var(--foreground-muted)" }}>
            Stack
          </h3>
